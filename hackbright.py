...
def assign_grade(github, title, grade):
    ...
    QUERY = """
        ...
        """
    db.session.execute(QUERY, {'student_github': github, 'project_title': title,
        'grade': grade})
    db.session.commit()

    print "Successfully added grade %d, for %s, by %s" % (grade, title, github)
...
def handle_input():
    ...
    while command != "quit":
        ...
        if command == "student":
            ...
            assign_grade(github, title, int(grade))
